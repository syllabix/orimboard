...
import { Circle as Circ, Transformer } from 'react-konva';
import { WidgetActions, WidgetData } from 'whiteboard/widget';


export const Circle: React.FC<WidgetData & WidgetActions> = ({ selected, onSelect, onChange, ...props }) => {
    const trRef: LegacyRef<ITransformer> = useRef(null);
    const shapeRef: LegacyRef<ICircle> = useRef(null);
